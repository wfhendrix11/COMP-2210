...
public final class Point implements Comparable<Point> {
  ...
  /** Compare two points with respect to the slope each
       makes with this point. */
   ...
   public double slopeTo(Point that) {
      double top = ((double) this.y - (double) that.y);
      double bottom = ((double) this.x - (double) that.x);  
   ...
   /**
    * Defines a total order for Points based on the slope that two specified 
    * points make with this point.
    */
